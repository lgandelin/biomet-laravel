        ...
        <div class="dashboard">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 30px;">
                    <div class="box">
                        ...
                        <div class="box-content row indicators">
                            <div class="col-lg-4 col-md-4 col-sm-12"><span class="title">Consommation électrique depuis le début de l'année (kWh)</span><span class="value">{{ number_format($sum_conso_elec_install_current_year, 0, '.', ' ') }}</span></div>
                            <div class="col-lg-4 col-md-4 col-sm-12"><span class="title">Volume cumulé biogaz brut (Nm<sup>3</sup>) (FT0101F)</span> <span class="value">{{ number_format($sum_ft0101f_current_year, 0, '.', ' ') }}</span></div>
                            <div class="col-lg-4 col-md-4 col-sm-12"><span class="title">Volume cumulé biométhane (Nm<sup>3</sup>) (FT0102F)</span> <span class="value">{{ number_format($sum_ft0102f_current_year, 0, '.', ' ') }}</span></div>
                        </div>
                        <div class="box-content row indicators">
                            <div class="col-lg-4 col-md-4 col-sm-12"><span class="title">Heures en fonctionnement (h)</span> <span class="value"><span class="value">{{ number_format($heures_en_fonctionnement_current_year, 0, '.', ' ') }}</span></div>
                            <div class="col-lg-4 col-md-4 col-sm-12"><span class="title">Quantité biométhane injecté (Nm<sup>3</sup>)</span><span class="value">{{ number_format($qte_biomethane_injecte_current_year, 0, '.', ' ') }}</span></div>
                            <div class="col-lg-4 col-md-4 col-sm-12"><span class="title">Quantité biométhane non-conforme (Nm<sup>3</sup>)</span> <span class="value">{{ number_format($qte_biomethane_non_conforme_current_year, 0, '.', ' ') }}</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @elseif ($current_facility->id == env('VIENNE_FACILITY_ID'))
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 30px;">
                        <div class="box">
                            <h1 class="box-title">CH<sub>4</sub> et CO<sub>2</sub> du biométhane (%)</h1>
                            <div class="box-content">
                                @include('biomet::pages.facility.includes.date_filters')
                                <div class="graph" id="container3" data-title="CH<sub>4</sub> et CO<sub>2</sub> du biométhane" data-keys="COMPO_CH4_GRDF,COMPO_CO2_GRDF" data-legend="CH<sub>4</sub> (%),CO<sub>2</sub> (%)"></div>
                                <div class="entrypoint"></div>
                            </div>
                        </div>
                    </div>
